...
class Generator(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        learned_mask = split_graph(data, edge_score, self.threshold)
...
class MyModel(nn.Module):
    def __init__(self, in_channels, hid_channels, num_cls, num_relations, threshold):
        super().__init__()
        ...
        self.graph_generator = Generator(input_dim=in_channels, hidden_dim=hid_channels, threshold=threshold)
